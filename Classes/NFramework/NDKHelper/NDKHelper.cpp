...
extern "C"
{
    ...
    void sendMessageWithData(string methodName,void* data,int length)
    {
        if (0 == strcmp(methodName.c_str(), ""))
            return;
        json_t *toBeSentJson = json_object();
                                           ...
                                           "(Ljava/lang/String;[B)V"))
        {
            ...
            t.env->CallStaticVoidMethod(t.classID, t.methodID, stringArg1, array);
            t.env->DeleteLocalRef(stringArg1);
        ...
        IOSNDKHelperImpl::recieveBytes(data, length);
